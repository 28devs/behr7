  ...
  return function i(a, f, l) {
      ...
      1: [function(e, t, o) {
          ...
          var l = function(e, t) {
            ...
            , f = function() {
              var e, t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", o = arguments[1], n = document.createElement("div");
              n.classList.add("basicLightbox"),
              null != o.className && (e = n.classList).add.apply(e, function(e) {
                  if (Array.isArray(e)) {
              ...
              var r = n.querySelector(".basicLightbox__placeholder")
                ...
                , a = l(r, "VIDEO")
                , f = l(r, "IFRAME");
              return !0 === i && n.classList.add("basicLightbox--img"),
              !0 === a && n.classList.add("basicLightbox--video"),
              !0 === f && n.classList.add("basicLightbox--iframe"),
              n
          };
          o.create = function(e, n) {
              ...
              var r = f(e, n)
                , o = function(e) {
                  return !1 !== n.beforeClose(i) && (o = function() {
                      if (n.afterClose(i),
                      "function" == typeof e)
                          return e(i)
                  }
                  ,
                  (t = r).classList.remove("basicLightbox--visible"),
                  setTimeout(function() {
                      return !1 === a(t) || t.parentElement.removeChild(t),
                      o()
                  }, 410),
                  !0);
                  var t, o
              ...
              !0 === n.closable && (r.onclick = function(e) {
                  var t;
                  e.target === this && (o(),
                  "function" == typeof (t = e).stopPropagation && t.stopPropagation(),
                  ...
                  show: function(e) {
                      ...
                      setTimeout(function() {
                          requestAnimationFrame(function() {
                              return t.classList.add("basicLightbox--visible"),
                              o()
                          })
                      }, 10),
                      !0);
  ...
  var g = function() {
    ...
    , y = function() {
      function n(t) {
          ...
          this.disabled = !1,
          this.selector = t,
          this.settings = function e(n, i) {
              return l(n) && l(i) && Object.keys(i).forEach(function(t) {
                  l(i[t]) ? (n[t] || a(n, s({}, t, {})),
                  e(n[t], i[t])) : a(n, s({}, t, i[t]))
              }),
              a({}, n)
          }(i, e),
      ...
      return o(e, [{
          ...
          value: function(t, e, n) {
              ...
              for (var i = 0; i < t.length; i++)
                  ...
                  e.addEventListener(t[i], this.listeners[t[i]], !1)
          }
      }, {
          key: "off",
          value: function(t, e) {
  ...
  var L = {
      Html: function(e, t) {
          var n = {
              mount: function() {
                  ...
                  this.track = this.root.querySelector(H),
                  this.slides = Array.from(this.wrapper.children).filter(function(t) {
      ...
      Peek: function(n, t, e) {
          ...
          m(i, "reductor", {
              get: function() {
                  ...
                  return l(t) ? t.before / e + t.after / e : 2 * t / e
              }
          }),
          ...
          var n = {
              ...
              apply: function(t) {
                  for (var e = 0, n = t.length; e < n; e++) {
                      var i = t[e].style
                        , r = o.Direction.value;
                      i[_[r][0]] = 0 !== e ? this.value / 2 + "px" : "",
                      e !== t.length - 1 ? i[_[r][1]] = this.value / 2 + "px" : i[_[r][1]] = ""
                  }
              },
              remove: function(t) {
                  for (var e = 0, n = t.length; e < n; e++) {
      ...
      Clones: function(s, u, t) {
          var e = {
              mount: function() {
                  this.items = [],
                  s.isType("carousel") && (this.pattern = this.map(),
                  this.items = this.collect())
              },
              map: function() {
                  for (var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [], e = s.settings.perView, n = u.Html.slides.length, i = 0; i < Math.max(1, Math.floor(e / n)); i++) {
                      for (var r = 0; r <= n - 1; r++)
                          t.push("" + r);
                      for (var o = n - 1; 0 <= o; o--)
                          t.unshift("-" + o)
              ...
              collect: function() {
                  for (var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [], e = this.pattern, n = 0; n < e.length; n++) {
                      ...
                      i.classList.add(s.settings.classes.cloneSlide),
                      t.push(i)
                  }
                  return t
              },
              append: function() {
                  for (var t = this.items, e = this.pattern, n = 0; n < t.length; n++) {
                      var i = t[n];
                      i.style.width = u.Sizes.slideWidth + "px",
                      "-" === e[n][0] ? u.Html.wrapper.insertBefore(i, u.Html.slides[0]) : u.Html.wrapper.appendChild(i)
                  }
              },
              remove: function() {
      ...
      Run: function(o, n, s) {
          var t = {
              ...
              calculate: function() {
                  ...
                  switch (i) {
                  case ">":
                      ">" === n ? o.index = e : this.isEnd() ? (this._o = !0,
                      o.index = 0,
                      s.emit("run.end", t)) : r ? o.index += Math.min(e - o.index, -p(n)) : o.index++;
                      break;
                  case "<":
                      "<" === n ? o.index = 0 : this.isStart() ? (this._o = !0,
                      o.index = e,
                      s.emit("run.start", t)) : r ? o.index -= Math.min(o.index, p(n)) : o.index--;
                      break;
                  case "=":
                      o.index = n
                  }
          ...
          var e = new T
            ...
            , t = {
              ...
              move: function(t) {
                  if (!c.disabled) {
                      var e = c.settings
                        ...
                        , u = Math.sqrt(o + s)
                        , a = Math.sqrt(s);
                      if (180 * (d = Math.asin(a / u)) / Math.PI < e.touchAngle && l.Move.make(i * parseFloat(e.touchRatio)),
                      !(180 * d / Math.PI < e.touchAngle))
                          return !1;
                      t.stopPropagation(),
                      t.preventDefault(),
                      l.Html.root.classList.add(e.classes.dragging),
                      f.emit("swipe.move")
                  }
              },
              end: function(t) {
                  if (!c.disabled) {
                      ...
                      this.enable(),
                      i < r && o < e.touchAngle ? (e.perTouch && (s = Math.min(s, p(e.perTouch))),
                      l.Direction.is("rtl") && (s = -s),
                      l.Run.make(l.Direction.resolve("<" + s))) : r < -i && o < e.touchAngle ? (e.perTouch && (s = Math.max(s, -p(e.perTouch))),
                      l.Direction.is("rtl") && (s = -s),
                      l.Run.make(l.Direction.resolve(">" + s))) : l.Move.make(),
                      l.Html.root.classList.remove(e.classes.dragging),
              ...
              bindSwipeStart: function() {
                  var t = c.settings;
                  t.swipeThreshold && e.on(M[0], l.Html.wrapper, this.start.bind(this)),
                  t.dragThreshold && e.on(M[1], l.Html.wrapper, this.start.bind(this))
              },
              unbindSwipeStart: function() {
                  e.off(M[0], l.Html.wrapper),
                  e.off(M[1], l.Html.wrapper)
              },
              bindSwipeMove: function() {
                  e.on(C, l.Html.wrapper, w(this.move.bind(this), c.settings.throttle))
              },
              unbindSwipeMove: function() {
                  e.off(C, l.Html.wrapper)
              },
              bindSwipeEnd: function() {
                  e.on(z, l.Html.wrapper, this.end.bind(this))
              },
              unbindSwipeEnd: function() {
                  e.off(z, l.Html.wrapper)
              },
              touches: function(t) {
                  return D.includes(t.type) ? t : t.touches[0] || t.changedTouches[0]
              },
              threshold: function(t) {
                  var e = c.settings;
                  return D.includes(t.type) ? e.dragThreshold : e.swipeThreshold
              },
              enable: function() {
                  return n = !1,
                  l.Transition.enable(),
              ...
              detach: function() {
                  ...
                  !r) {
                      for (var t = 0; t < this.items.length; t++)
                          ...
                          this.items[t].dataset.href = this.items[t].getAttribute("href"),
              ...
              attach: function() {
                  ...
                  r) {
                      for (var t = 0; t < this.items.length; t++)
                          ...
                          this.items[t].setAttribute("href", this.items[t].dataset.href),
                          delete this.items[t].dataset.href;
                      r = !1
                  }
                  return this
              }
          ...
          var n = new T
            , r = {
              mount: function() {
                  ...
                  this._i = e.Html.root.querySelectorAll('[data-glide-el^="controls"]'),
                  this.addBindings()
              },
              setActive: function() {
              ...
              click: function(t) {
                  t.preventDefault(),
                  e.Run.make(e.Direction.resolve(t.currentTarget.dataset.glideDir))
              }
          };
          return m(r, "items", {
              get: function() {
      ...
      Autoplay: function(e, n, t) {
          var i = new T
            , r = {
              ...
              start: function() {
                  var t = this;
                  e.settings.autoplay && h(this._i) && (this._i = setInterval(function() {
                      t.stop(),
                      n.Run.make(">"),
                      t.start()
                  }, this.time))
          ...
          return m(r, "time", {
              get: function() {
                  ...
                  return p(t || e.settings.autoplay)
              }
          }),
  ...
  return function(t) {
      ...
      o(e, [{
          ...
          value: function() {
              ...
              }(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, a({}, L, t))
          }
      }]),
      e
  }()
  ...
  return function(a, d) {
      ...
      S.animateScroll = function(t, a, r) {
          ...
          if (d || h) {
              ...
              v || (v = s(p));
              var b, y, E, I = d ? t : c(h, v, parseInt("function" == typeof f.offset ? f.offset() : f.offset, 10)), O = I - g, A = u(), C = 0, w = function(n, o) {
                  var r = e.pageYOffset;
                  ...
                  w(E, I) || (e.requestAnimationFrame(Q),
                  b = t)
              };
      ...
      ;
      var E = function(e) {
          h && (h.id = h.getAttribute("data-scroll-id"),
          S.animateScroll(h, g),
          h = null,
          g = null)
      }
        , I = function(t) {
          if (!f() && 0 === t.button && !t.metaKey && !t.ctrlKey && (g = t.target.closest(a)) && "a" === g.tagName.toLowerCase() && !t.target.closest(m.ignore) && g.hostname === e.location.hostname && g.pathname === e.location.pathname && /#/.test(g.href)) {
              ...
              if ("#" === n) {
                  ...
                  return h.setAttribute("data-scroll-id", o),
                  h.id = "",
                  void (e.location.hash.substring(1) === o ? E() : e.location.hash = o)
              }
              h = document.querySelector(n),
              h && (h.setAttribute("data-scroll-id", h.id),
              h.id = "",
              g.hash === e.location.hash && (t.preventDefault(),
              E()))
          }
      }
        , O = function(e) {
      ...
      return S.destroy = function() {
          m && (document.removeEventListener("click", I, !1),
...
var CustomSelect = function(e) {
  function t(e) {
      ...
      if (t.className === c && n(),
      "LI" === t.tagName) {
          u.querySelector("." + c).innerText = t.innerText,
          s.options.selectedIndex = t.getAttribute("data-index");
          for (var l = 0; l < d; l++)
              v.querySelectorAll("li")[l].classList.remove(i);
          t.classList.add(i),
          a()
      }
  }
  function n() {
      v.classList.toggle(o)
  }
  function l() {
      v.classList.add(o)
  }
  ...
  var s = document.getElementById(e.elem)
    ...
    , i = "is-selected"
    , o = "is-open"
    , r = s.querySelectorAll("option")
    , d = r.length
    , u = document.createElement("div");
  u.className = "js-Select",
  u.id = "custom-" + e.elem;
  var m = document.createElement("button");
  m.className = c,
  m.textContent = r[0].textContent;
  var v = document.createElement("ul");
  v.className = "js-Select-list";
  for (var p = 0; p < d; p++) {
      var f = document.createElement("li");
      f.innerText = r[p].textContent,
      f.setAttribute("data-value", r[p].value),
      f.setAttribute("data-index", p),
      null !== r[p].getAttribute("selected") && (f.classList.add(i),
      m.textContent = r[p].textContent),
      v.appendChild(f)
  }
